...
const CATEGORIES: Category[] = [
  {
    ...
    example: 'เข้าใจเลยค่ะว่าเรื่องนี้น่าหงุดหงิด ต้องขอโทษด้วยจริง ๆ ที่เกิดเรื่องนี้ขึ้น',
  },
  {
    ...
    example: 'ปกติเรื่องนี้ใช้เวลาไม่เกินตามนโยบาย เดี๋ยวแจ้งกรอบเวลาที่ชัดเจนให้ทางร้านนะคะ',
  },
  {
    ...
    example: 'เดี๋ยวแอดมินติดตามเรื่องนี้ให้เอง แล้วจะอัปเดตผลกลับไปทันทีที่ทราบผล',
  },
  {
    ...
    example: 'ขอตรวจสอบข้อมูลและหลักฐานการจัดส่งก่อนนะคะ แล้วจะแจ้งผลให้ทราบ',
  },
  {
    ...
    example: 'ถ้าตรวจสอบแล้วพบว่าเป็นความผิดพลาดของระบบ ทางเราจะดำเนินการคืนเงินหรือชดเชยส่วนต่างให้',
  },
  {
    ...
    example: 'เดี๋ยวบันทึกเป็นเคสและส่งต่อให้ทีมที่ดูแลเรื่องนี้โดยตรง เพื่อติดตามต่อให้',
  },
  {
    ...
    example: 'ขอจัดการเคสที่กระทบลูกค้าปลายทางก่อนนะคะ เพราะเร่งด่วนกว่า แล้วจะรีบกลับมาที่เรื่องนี้',
  },
  {
    ...
    example: 'ลองตรวจการเชื่อมต่อและเปิดปิดเครื่องใหม่ก่อนนะคะ ถ้ายังไม่หายจะส่งต่อทีมช่างให้',
  },
  {
    ...
    example: 'ขอตรวจสอบว่าเมนูและโปรไฟล์ร้านครบถ้วนและเผยแพร่อยู่ไหม เพราะมีผลกับการถูกค้นเจอ',
  },
  {
    ...
    example: 'อาการนี้มักไม่ได้เกิดจากค่าโฆษณาโดยตรงค่ะ ขอตรวจสอบสาเหตุอื่นก่อน',
  },
  {
    ...
    example: 'ต้องตั้งสูตร (BOM) ให้ระบบตัดสต๊อกวัตถุดิบอัตโนมัติทุกครั้งที่มีการขาย',
  },
];
